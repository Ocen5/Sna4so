...
public final class SOQueryQuestionUsrEdge extends ASOQuery implements ISOQuery {
	...
	/**
	 * User 	The id of the User of the query
	 ...
	 * @param usr 	The user parameter to be inserted in the query.
	 ...
	 **/
	public SOQueryQuestionUsrEdge(final Integer usr, final Integer lim) 
	...
	public Job runQuery() throws InterruptedException {
		...
		QueryJobConfiguration queryConfig = QueryJobConfiguration.newBuilder("SELECT "
				...
				.addNamedParameter("user", QueryParameterValue.int64(user))
